...
import { TouchableOpacity, Dimensions,Platform, ScrollView, KeyboardAvoidingView, NetInfo, ActivityIndicator, View, Image, StyleSheet, Text, I18nManager } from "react-native";
...
class Welcome extends Component {
    ...
    content = (
        ...
        <CustomButton onPress={async () => this.GetVisitor()
            ...
            text={localization.signIn} style={{  width: '40%', backgroundColor: Colors.orange }} />
        </ListItem>
           ...
           // debugger;
            this.content = (
                <CustomButton onPress={async () => this.GetVisitor()
                    ...
                    text={localization.signIn} style={{alignSelf:'center',marginTop:'5%', width: '60%', backgroundColor: Colors.orange }} />
            )
            ...
            <View style={{ }}>
                ...
                <ListItem>
                    <Left style={{ }}>
                        ...
                        onChange={(state)=>{this.setState({ rememberMe: state });}}
                        style={{}}
                    />
                    <Text style={[styles.rememberMeText,]}>{localization.rememberMe} </Text>
                ...
                <View style={styles.registerContainer}>
                    ...
                    }} text={localization.trainer_consultant} style={{ backgroundColor: Colors.white,height:Dimensions.get('screen').height*0.09 }} textStyle={{color:Colors.lightBlue}} />
                    ...
                    }} text={localization.center+'\n'+localization.trainingCenters_Consultancy} style={{ backgroundColor: Colors.white,height:Dimensions.get('screen').height*0.09,padding: 5,  }} textStyle={{color:Colors.lightBlue,fontSize:13}} />

                    <CustomButton text={localization.visitor} style={{ backgroundColor: Colors.white, height:Dimensions.get('screen').height*0.09,}} textStyle={{color:Colors.lightBlue}} onPress={async () => {
                       // debugger;
                        const connected = await this.checkConnection();
                        if (connected) {
